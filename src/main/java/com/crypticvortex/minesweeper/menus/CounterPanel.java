...
public class CounterPanel extends JPanel {
    ...
    public void setDigits() {
        ...
        for (char c : score.toCharArray()) {
            ...
            switch (c) {
                case '0':
                    icon = MenuIcons.COUNTER_0;
                    break;
                case '1':
                    icon = MenuIcons.COUNTER_1;
                    break;
                case '2':
                    icon = MenuIcons.COUNTER_2;
                    break;
                case '3':
                    icon = MenuIcons.COUNTER_3;
                    break;
                case '4':
                    icon = MenuIcons.COUNTER_4;
                    break;
                case '5':
                    icon = MenuIcons.COUNTER_5;
                    break;
                case '6':
                    icon = MenuIcons.COUNTER_6;
                    break;
                case '7':
                    icon = MenuIcons.COUNTER_7;
                    break;
                case '8':
                    icon = MenuIcons.COUNTER_8;
                    break;
                case '9':
                    icon = MenuIcons.COUNTER_9;
                    break;
                case '-':
                    icon = MenuIcons.COUNTER_DASH;
                    break;
            }
